    ...
    return (
        <div className='flex min-h-screen grainy'>
            <section className='bg-brand-100 p-10 hidden w-1/2 items-center justify-center lg:flex xl:w-2/5'>
                <div className='flex max-h-[800px] max-w-[460px] flex-col justify-center space-y-12'>
                    <Image
                        src="/assets/logo.svg"
                        alt="logo"
                        width={224}
                    ...
                    <Image
                        src="/assets/3d-box.png" alt="Files" width={342} height={342} className='transition-all hover:rotate-2 hover:scale-105'
                    />
                </div>
            </section>
